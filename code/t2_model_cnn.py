    ...
    def train(self,restore=False):
        ...
        with tf.Session(config=tf.ConfigProto(allow_soft_placement=True,log_device_placement=False)) as sess:
            try:
                ...
                if restore:
                    saver.restore(sess, tf.train.latest_checkpoint('./saves_t2'))
                else:
                ...
                while True:
                    ...
                    if counter%1000 == 0:
                        ...
                        if acc_m[0] > 0.65:
                            ...
                            save_path = saver.save(sess, './saves_t2/model_%d.ckpt'%check_step)
    ...
    def infer(self, batch_size):
        ...
        with tf.Session(config=tf.ConfigProto(allow_soft_placement=True,log_device_placement=False)) as sess:
            ...
            for i in range((507783//batch_size) + 1):
                ...
                pred = sess.run([self.prediction_m], feed_dict={self.x_placeholder: val_x, self.training: False})
